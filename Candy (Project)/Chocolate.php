...
<div class="PicsOFCandy text-center">
  <br><br>
    <p style="margin: 30px;">
      Undoubtedly one of the tastiest flavors ever to have been discovered, we have an entire candy category designated for this all time favorite treat. Yes ladies and gents, we're talking about chocolate. And although it doesn't need an introduction, we're going to give it a fantastic one! From chocolate candy bars, to foil wrapped chocolate stars, to M&Ms, chocolate and espresso truffles, and so many more mouthwatering selections, you can indulge for hours with any of our bulk supplies. If you're a chocoholic, then you've come to the right place. Bring home some amazing chocolates today for you and your family to savor.
    </p>
    <br><br>
</div>
...
<div class="row">
  <div class="col-sm-3">
    <img src="img/C1.jpg">
    <h4  style="font-family: cursive;">Chocolate Bulk Candy Mix </h4><br>
  </div>
  <div class="col-sm-3">
    <img src="img/C2.jpg">
    <h4 style="font-family: cursive;">Gold Milk Chocolate  </h4><br>
  </div>
  <div class="col-sm-3">
    <img src="img/C3.jpg">
    <h4 style="font-family: cursive;">Red Milk Chocolate Stars </h4><br>
  </div>
  <div class="col-sm-3">
    <img src="img/C4.jpg">
    <h4 style="font-family: cursive;">Marshmallow Caramel Sticks  </h4><br>
  </div>
